...
The dataset consists of numerical values representing noise levels over time.

## Methods
The following steps are applied in the project:
- Data loading and examination
- Data cleaning and preprocessing
- Noise level analysis
- Visualization of noise patterns
